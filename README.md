...
<p align="center"><sub><strong>This admin was generated by RustIO Admin.</strong> Rendered from a Rust struct — search, filter, sort, export, status, and a foreign key to the assigned translator. Not a mockup, not a frontend template: a generated Rust admin system. <em>(The <a href="./examples/translation-agency"><code>translation-agency</code></a> project, from the <a href="./docs/quickstart-translation-agency.md">Quick Start</a>.)</em></sub></p>
