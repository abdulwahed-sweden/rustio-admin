# shop — rustio-admin example

A small but complete **e-commerce admin** built on `rustio-admin`: a
product catalog, customers, orders with line items and payments, and
...
5-minute orientation to the code.
